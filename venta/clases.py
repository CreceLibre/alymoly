#!/usr/bin/env python
#-*- encoding: UTF-8 -*-
from venta.excepciones import TurnoError
...
from movimiento import models as movimiento_models
from devolucion import models as devolucion_models
from venta.recursos import formato_dinero
from venta.excepciones import *
