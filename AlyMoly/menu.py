...
class CustomMenu(Menu):
    ...
    def __init__(self, **kwargs):
        ...
        self.children.append(MenuItem(
            title=_('Inventario'),
            children=[
                MenuItem(title=_('Inventario actual'),
                         url=reverse('inventario:actual')),
                MenuItem(title=_('Reiniciar Inventario'),
                         url=reverse('inventario:reiniciar')),
                MenuItem(title=u'Stock Critico',
        ...
        self.children.append(MenuItem(
            ...
            children=[
                MenuItem(title=_('General'), children=[
                    MenuItem(title=_('Productos'),
                             url=reverse('reporte:productos')),
                    MenuItem(title=_('Existencias'),
                             url=reverse('reporte:existencias')),
                ]),
