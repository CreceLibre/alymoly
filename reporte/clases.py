#-*- encoding: UTF-8 -*-
import urllib
from reporte.excepciones import AbstractClassException
from settings import REPORT_HOST, REPORT_PORT, REPORT_APP, REPORT_DIR,\
                     NOMBRE_SUCURSAL, CANTIDAD_PRODUCTOS_MAS_VENDIDOS,\
                    CANTIDAD_PROMOCIONES_MAS_VENDIDAS
from reporte.conexion import URLRetriever 
