#-*- encoding: UTF-8 -*-
from mantenedor.models import Producto, Bodega, Categoria, Promocion, ProductoPromocion, Proveedor, Trabajador
from mantenedor.forms import BodegaForm, CategoriaForm, ProductoForm, PromocionForm, ProveedorForm, TrabajadorForm
from django.contrib import admin
from django.contrib.auth.models import User
from mantenedor import recursos
